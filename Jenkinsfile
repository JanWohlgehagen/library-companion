            ...
            parallel {
                ...
                stage("Meta stage,  builds frontend, runs tests and runs a dockerized app"){
                    stages{
                        ...
                        {
                            steps{
                                sh "k6 run -v frontend/tests/K6-tests/loadTest.js"
                                sh "k6 run -v frontend/tests/K6-tests/stressTest.js"
                                sh "k6 run -v frontend/tests/K6-tests/soakTest.js"
                                sh "k6 run -v frontend/tests/K6-tests/spikeTest.js"
                            }
                        }
